...
@Configuration
@EnableJpaRepositories(basePackages = "com.webdatabase.dgz.repository", transactionManagerRef = "jpaTransactionManager")
@PropertySource(value = { "classpath:application.properties" })
@EnableTransactionManagement
public class JpaConfig {

	private static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "com.webdatabase.dgz.model" };
